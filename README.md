...
- Salva os contatos no localStorage, então eles não se perdem ao atualizar a página
- Carrega automaticamente os contatos salvos quando o site é aberto
- Mostra todos os contatos em uma tabela
- Permite excluir contatos
- Atualiza a lista automaticamente ao adicionar ou remover um contato
- Mostra o total de contatos cadastrados
